# ----------------------------------- https://github.com/theseeker99/clonebot-v1.5 --------------------------------------------#
...
├ Clone started - {}
├ Last updated  - {}</code>
├  🔰 <a href='t.me/RMProjects'><b>@MrUnknown114</b></a> || 🏅 <a href='https://github.com/theseeker99/clonebot-v1.5'><b>@Github</b></a>
╰──────⌈ 💢 Clonebot ⌋─────╯"""
    DUPLICATE_INDEX = """
╭──────⌈ ⚠️ Skipping ⌋──────╮<code>
├ CMID - {}
...
𝐃𝐞𝐥𝐚𝐲𝐞𝐝 : {} | 𝐂𝐚𝐩𝐭𝐢𝐨𝐧 : {}"""
    ...
    COPIED_MESSAGES = "<b><a href='https://github.com/theseeker99/clonebot-v1.5'>Medias Copied</a></b>"
