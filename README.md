...
<p align="left">
    ...
    <br>
        2. Change the <a href="https://github.com/theseeker99/clonebot-v1.5/blob/master/app.json#L7" target="_blank"> app.json </a> 'repository' URL to your fork URL.
    <br>
        3. Change the <a href="https://github.com/theseeker99/clonebot-v1.5/blob/master/README.md?plain=1#L25" target="_blank"> deploy button </a> URL to your fork URL.
    <br>
    ...
    <br><br>
      <a href="https://heroku.com/deploy?template=https://github.com/theseeker99/clonebot-v1.5" target="_blank">
        <img height="30px" src="https://img.shields.io/badge/Deploy%20to-Heroku-orange"></a>
    <br><br>
    <a href="https://t.me/the_seeker_s_cave" target="_blank">@MrUnknown114</a>
</p>
